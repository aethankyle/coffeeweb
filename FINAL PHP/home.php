...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #DEDEDE;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <a href="home.php"><img src="Pictures/logo1.png" width="120px" height="120px"></a>
            ...
            <ul class="dropdown-menu dropdown-menu" aria-labelledby="dropdownMenuButton2">
                <li><a class="dropdown-item" href="../User_Index/login.php">Login as User</a></li>
                <li><a class="dropdown-item" href="../Admin_Index/login.php">Login as Admin</a></li>
            </ul>
            </div>
         </div>
          </ul>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 py-0 py-lg-5">
                            ...
                            <h5 class="mb-3">Coffee Web was built in 2024 where every classic coffee happens here. We started on a small business place in the culinary capital of the Philippines, Angeles City. We strive hard to dedicate our passion to making coffee and serving people wholeheartedly.</p>
