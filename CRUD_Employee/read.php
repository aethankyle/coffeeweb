            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row['EMPF_NAME']; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Employee Last Name</label>
                        <p><b><?php echo $row['EMPL_NAME']; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Employee Phone Number</label>
                        <p><b><?php echo $row['EMPPHONE_NUM'];?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Street</label>
                        <p><b><?php echo $row['EMP_STREET']; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>City</label>
                        <p><b><?php echo $row['EMP_CITY']; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Zip</label>
                        <p><b><?php echo $row['EMP_ZIP'];?></b></p>
                    </div>
