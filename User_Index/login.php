...
<head>
    ...
    <?php
        ...
        if (isset($_POST['username'])) 
        {
            ...
            $query = "SELECT * FROM tbluser WHERE username='$username' and password='" . md5($password) . "'";
                ...
                <div class="row g-0">
                    ...
                    <div class="card-body p-4 p-lg-5 text-black">
                        ...
                        <div class="d-flex align-items-center mb-3 pb-1">
                            ...
                            <span class="h1 fw-bold mb-0">Coffee Web User</span>
                        </div>
                        ...
                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="UserRegistration.php"
